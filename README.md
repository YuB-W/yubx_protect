...
Open your web browser and navigate to [(http://<your_local_ip>:5000)](http://<your_local_ip>:5000) to access the YuB Protect web interface make sure is your local ip from kali linux.
